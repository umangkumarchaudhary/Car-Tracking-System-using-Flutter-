...
class PartsEstimateDashboardScreen extends StatefulWidget {
  final String authToken;
  final String dashboardTitle;

  const PartsEstimateDashboardScreen({Key? key, required this.authToken, required this.dashboardTitle})
      : super(key: key);

  @override
  State<PartsEstimateDashboardScreen> createState() => _PartsEstimateDashboardScreenState();
}

class _PartsEstimateDashboardScreenState extends State<PartsEstimateDashboardScreen> {
  String filter = "today";
  ...
  Future<void> fetchDashboardData() async {
    ...
    try {
      final url = Uri.parse("http://192.168.58.49:5000/api/dashboard/parts-estimate?filter=$filter");
