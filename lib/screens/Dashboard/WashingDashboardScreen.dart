...
class WashingDashboardScreen extends StatefulWidget {
  final String authToken;
  final String dashboardTitle;

  const WashingDashboardScreen({Key? key, required this.authToken, required this.dashboardTitle})
      : super(key: key);

  @override
  State<WashingDashboardScreen> createState() => _WashingDashboardScreenState();
}

class _WashingDashboardScreenState extends State<WashingDashboardScreen> {
  String filter = "today";
  ...
  Future<void> fetchDashboardData() async {
    ...
    try {
      final url = Uri.parse("http://192.168.58.49:5000/api/dashboard/washing?filter=$filter");
