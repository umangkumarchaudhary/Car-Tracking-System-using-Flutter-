...
class FinalInspectionDashboardScreen extends StatefulWidget {
  final String authToken;
  final String dashboardTitle;

  const FinalInspectionDashboardScreen({Key? key, required this.authToken, required this.dashboardTitle})
      : super(key: key);

  @override
  State<FinalInspectionDashboardScreen> createState() => _FinalInspectionDashboardScreenState();
}

class _FinalInspectionDashboardScreenState extends State<FinalInspectionDashboardScreen> {
  String filter = "today";
  ...
  Future<void> fetchDashboardData() async {
    ...
    try {
      final url = Uri.parse("http://192.168.58.49:5000/api/dashboard/final-inspection?filter=$filter");
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "${vehicle['durationMinutes'] ?? '0'} mins",
                          style: const TextStyle(
                            fontSize: 14,
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              crossAxisSpacing: 12,
              children: [
                _buildStatItem(Icons.loop, "Processed", summary['totalProcessed']?.toString() ?? '0'),
                  ...
                  children: [
                    ...
                    if (showCompleted) ...[
                      ...
                      if (completedVehicles.isEmpty)
                        const Text("No completed vehicles.")
                      else
