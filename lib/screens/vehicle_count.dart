...
class VehicleCountScreen extends StatefulWidget {
  ...
  @override
  _VehicleCountScreenState createState() => _VehicleCountScreenState();
}

class _VehicleCountScreenState extends State<VehicleCountScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    if (widget.vehicleCountPerStage.isEmpty) {
      return Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildPerformanceTable(
                    headers: ["STAGE", "VEHICLE COUNT"],
                    rows: widget.vehicleCountPerStage.map<List<String>>((stage) {
                      return [stage["displayName"].toString(), stage["totalVehicles"].toString()];
                    }).toList(),
                  ),
                ],
              ),
